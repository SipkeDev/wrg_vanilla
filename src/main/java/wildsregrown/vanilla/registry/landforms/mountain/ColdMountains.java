...
public class ColdMountains extends Landform {
    ...
    public ColdMountains() {
        super(modid, "cold_mountains",1f, Placement.Elevation.mountain, Climate.ice, Climate.tundra, Climate.polarDesert);
        register(new StratumConfig(VanillaMaterials.stone.getIndex(), 12, 24, 2));
        register(new StratumConfig(VanillaMaterials.black_stone.getIndex(), 12, 34, 5));
        register(new StratumConfig(VanillaMaterials.calcite.getIndex(), 4, 8, 1));
    }
