...
public class HighLands extends Landform {
    ...
    public HighLands() {
        super(modid, "highlands",0.5f, Placement.Elevation.highland, Climate.coniferousForest, Climate.mixedForest, Climate.steppe, Climate.chaparral, Climate.deciduousForest);
        register(new StratumConfig(VanillaMaterials.stone.getIndex(), 24, 50, 5));
        register(new StratumConfig(VanillaMaterials.tuff.getIndex(), 3, 5, 2));
        register(new StratumConfig(VanillaMaterials.deepslate.getIndex(), 12, 24, 2));
    }
