package wildsregrown.vanilla.registry.landforms.ocean;
...
public class Abyss extends Landform {
    ...
    public Abyss() {
        super(modid, "abyss",0.02f, Placement.Elevation.ocean, Climate.coldOcean, Climate.temperateOcean, Climate.warmOcean);
        register(new StratumConfig(VanillaMaterials.basalt.getIndex(), 24, 50, 1));
    }
