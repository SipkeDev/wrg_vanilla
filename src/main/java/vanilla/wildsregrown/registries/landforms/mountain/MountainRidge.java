...
public class MountainRidge extends Landform {
    ...
    public MountainRidge() {
        super(1f, Placement.Elevation.mountain, Climate.mixedForest, Climate.coniferousForest, Climate.ancientForest, Climate.spiritForest, Climate.deciduousForest, Climate.steppe);
